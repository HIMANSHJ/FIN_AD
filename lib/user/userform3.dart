...
class UserForm3 extends StatefulWidget {
  @override
  _SignUpFormState createState() => new _SignUpFormState();
}

class _SignUpFormState extends State<UserForm3> {
  FirebaseDatabase dbref3 = FirebaseDatabase.instance;
  ...
  List<Widget> getFormWidget() {
    ...
    formWidget.add(new TextFormField(
        ...
        validator: (value) {
          if (value.isEmpty) {
            return 'Please enter the type of vehicle';
          }
          return null;
        },
        onSaved: (value) {
  ...
  void onPressedSubmit() {
    if (_formKey.currentState.validate() && _termsChecked) {
      ...
      dbref3
          ...
          .child("name")
          .set(name);
      dbref3.reference().child("User3").child("user3_id").child("age").set(age);
      dbref3
          .reference()
          .child("User3")
          .child("user3_id")
